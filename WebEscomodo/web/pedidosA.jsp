                         ...
                         %>
                          <tr>
                            ...
                            <%if(a.getCalificacion() == 0 && a.getEstado().equals("Entregado")){%>
                                <td>
                                    <i onmouseover="starmark(this)" onclick="result()" id="1one" class="fa fa-2x fa-cookie"></i>
                                    <i onmouseover="starmark(this)" onclick="result()" id="2one" class="fa fa-2x fa-cookie"></i>
                                    <i onmouseover="starmark(this)" onclick="result()" id="3one" class="fa fa-2x fa-cookie"></i>
                                    <i onmouseover="starmark(this)" onclick="result()" id="4one" class="fa fa-2x fa-cookie"></i>
                                    <i onmouseover="starmark(this)" onclick="result()" id="5one" class="fa fa-2x fa-cookie"></i>
                                </td>
                                <%}%>
                          </tr>
                         <%}%>
